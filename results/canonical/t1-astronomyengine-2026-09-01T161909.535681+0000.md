...
**Generated:** 2026-09-01T16:19:09.535681+00:00  
**Python:** 3.14.6
...
| Reason | Count |
|---|---|
| Astronomy Engine adapter does not answer the sidereal `position` case kind — this library is tropical-only. Answers `tropical_position` instead. | 1800 |
